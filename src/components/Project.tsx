    ...
    <section id="project" className="py-20 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-indigo-900">Project</h2>
          <div className="w-16 h-1 bg-indigo-500 mx-auto mb-6"></div>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            My professional projects have helped me develop practical skills and apply theoretical knowledge in real-world settings.
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
            <div className="p-6 md:p-8">
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
                <div>
                  <h3 className="text-2xl font-bold text-indigo-800 mb-2">Text Classification with TensorFlow</h3>
              ...
              <div className="mb-6">
                <p className="text-gray-700 mb-4">
                  Skillvoid is collaborated with E-cell IIT Roorkee. During my training, I had the opportunity to gain hands-on project and develop my skills in various areas.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex">
                    ...
                    <p className="text-gray-700">Developed a text classification model achieving 92% accuracy using LSTM, GRU, and CNN on 100,000+ samples.</p>
                  </li>
                 <li className="flex">
                    <div className="flex-shrink-0 w-5 h-5 bg-indigo-500 rounded-full mt-1 mr-3"></div>
                    <p className="text-gray-700">Cut training time by 20% over 10 epochs, boosting accuracy by 15% with TF-IDF and tokenization.</p>
                  </li>
                  <li className="flex">
                    <div className="flex-shrink-0 w-5 h-5 bg-indigo-500 rounded-full mt-1 mr-3"></div>
                    <p className="text-gray-700">Enhanced model performance, reducing loss by 20% through effective pre-processing and
        ...
        <div className="max-w-4xl mx-auto my-5">
          <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
            <div className="p-6 md:p-8">
              ...
              <div className="mb-6">
                <p className="text-gray-700 mb-4">
                Completed professional training in Data Analytics at Anudip Foundation, gaining hands-on project with tools like Excel, SQL, Python, and Power BI, and working on real-world datasets to develop analytical and visualization skills.
                </p>
              </div>
